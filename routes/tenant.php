...
Route::group(['namespace' => 'Frontend'], function () {
    ...
    Route::get('/home2', function () {
        return redirect()->route('frontendHomePage', [], 301);
    })->name('home2.redirect');

    Route::get('/{legacyHomePage}', function () {
        return redirect()->route('frontendHomePage', [], 301);
    })->where('legacyHomePage', 'home0|home1|home3|home4|home5|home6|home7|home8|home9|home10')
        ->name('legacyHomePage.redirect');
    ...
    Route::get('/corporate-training', 'WebsiteController@corporateTraining')->name('corporateTraining');
    Route::get('/accreditation', 'WebsiteController@accreditation')->name('accreditation');
