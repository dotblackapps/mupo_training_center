                            ...
                            <div class="col-md-12">
                                @if(gv($product, 'name'))
                                    ...
                                    <div class="text-center">
                                        ...
                                        <button type="button" class="primary-btn fix-gr-bg" data-bs-toggle="modal"
                                                data-bs-target="#update_modal" data-bs-modal-size="modal-md">Update
                                        </button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <form method="POST" action="{{ route('service.download') }}" id="content_form"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12" id="download_buttons">
                                    <p class="text-center">Are You sure to update <br>
                                        version {{ gv($product, 'next_release_version') }} <br>
                                        Size of {{ bytesToSize(gv($product, 'next_release_size', 0)) }}
                                    </p>
                                </div>
                                <div class="col-md-12" id="on_progress" style="display: none;">
                                    <p class="text-center alert alert-danger">Don't perform any action till we are
                                        performing update!</p>

                                    <p class="text-center">Update Size
                                        ({{ bytesToSize(gv($product, 'next_release_size', 0)) }}) - Updating.....</p>

                                </div>
                                <div class="col-lg-12 text-center">
                                    <div class="mt-40 d-flex justify-content-between">
                                        <button type="button" class="primary-btn tr-bg" data-bs-dismiss="modal">
                                            Cancel
                                        </button>

                                        <button type="submit" class="primary-btn fix-gr-bg submit" id="update">Update
                                        </button>
                                        <button type="button" class="primary-btn fix-gr-bg submitting"
                                                style="display: none; " disabled="">Updating...
                                        </button>
