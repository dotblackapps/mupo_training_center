...
.mupo-learner-sidebar{background:linear-gradient(180deg,#061b3a 0%,#08294e 100%)!important;border:0!important;box-shadow:none!important}.mupo-sidebar-brand{height:74px;background:#fff;display:flex;align-items:center;justify-content:center;position:relative;border-right:1px solid var(--mupo-line)}.mupo-sidebar-brand img{height:54px;width:auto;object-fit:contain}.mupo-sidebar-brand .sidebar_close_icon{position:absolute;right:15px;color:var(--mupo-navy)}.mupo-sidebar-body{height:calc(100vh - 74px);overflow-y:auto;display:flex;flex-direction:column;padding:22px 14px 18px}.mupo-sidebar-nav{display:flex;flex-direction:column;gap:5px}.mupo-sidebar-nav a{position:relative;color:#fff!important;display:flex!important;align-items:center;gap:13px;padding:13px 15px;border-radius:8px;text-decoration:none;font-size:14px;font-weight:600;transition:.2s ease}.mupo-sidebar-nav a i{width:20px;text-align:center;font-size:17px}.mupo-sidebar-nav a:hover{background:rgba(255,255,255,.09)}.mupo-sidebar-nav a.active{background:var(--mupo-red)!important;color:#fff!important}.mupo-sidebar-nav a.active:before{content:"";position:absolute;left:-14px;top:8px;bottom:8px;width:3px;background:#fff;border-radius:0 3px 3px 0}.mupo-sidebar-quote{margin-top:auto;padding:22px 10px 4px;color:#fff;border-top:1px solid rgba(255,255,255,.18)}.mupo-sidebar-quote>span{display:block;width:34px;height:3px;background:var(--mupo-red);margin-bottom:13px}.mupo-sidebar-quote p{font-size:12px;line-height:1.55;margin:0 0 7px;color:#fff}.mupo-sidebar-quote small{color:rgba(255,255,255,.6)}
